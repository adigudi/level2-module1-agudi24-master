...
public class GamePractice extends JPanel implements ActionListener, KeyListener{
	...
	public void run(){
		...
		platforms.add(new Platform(700, 150, 200, 50));
		platforms.add(new Platform(500, 250, 200, 50));
		platforms.add(new Platform(300, 350, 200, 50));
		platforms.add(new Platform(100, 450, 200, 50));
